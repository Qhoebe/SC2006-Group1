...
import {
  faCar, faMotorcycle, faTruck, faScrewdriverWrench, faGasPump,
  faBookmark, faStar, faStarHalfAlt
...
function Markers(props) {
  ...
  const toggleFavourite = async () => {
    ...
    try {
      ...
      console.error(`Error ${isFavourited ? 'deleting' : 'adding'} favourite:`, error);
    }
  };
        ...
        >
          ...
          <div className="flex flex-row items-center justify-between">
            ...
            <button onClick={toggleFavourite}>
              <FontAwesomeIcon icon={faBookmark} color={isFavourited ? '#FFC000' : 'lightgray'} size='lg' />
            </button>
          </div>
  ...
  return (
    <div className="items-center justify-between flex flex-row ">
      ...
      <div className="flex flex-col py-2">
       ...
       {selectedPlace.Rating && <h1>Ratings:({selectedPlace.Rating})
